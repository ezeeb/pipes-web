...
@Module(//
label = "Post binary data (HTTP POST)", //
icon = "internet.png", //
inPorts = { //
		@InPort(name = BaseModule.PORT_TRIGGER, label = "Trigger", isOptional = true), //
		@InPort(name = BaseModule.PORT_URL, label = "Url"), //
		@InPort(name = BinaryPost.PORT_BODY, label = "Request Body"), //
		@InPort(name = BinaryPost.PORT_CONTENTTYPE, label = "Content Type", isOptional = true) }, //
outPorts = {//
...
public class BinaryPost extends BaseModule {
